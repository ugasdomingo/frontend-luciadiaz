    ...
    <div class="col-12 col-sm-6 col-md-5">
      ...
      <q-form @submit.prevent="handleSubmit">
        ...
        <div class="registro-buttom">
          <q-btn label="Guardar Registro" color="primary" type="submit"></q-btn>
        </div>
      </q-form>
    </div>
  </q-page>
